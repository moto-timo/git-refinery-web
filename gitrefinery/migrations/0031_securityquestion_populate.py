...
from gitrefinery.securityquestions import security_questions


def populate_security_questions(apps, schema_editor):
    SecurityQuestion = apps.get_model('gitrefinery', 'SecurityQuestion')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gitrefinery', '0030_securityquestion'),
    ]
