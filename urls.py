...
from gitrefinery.auth_views import CaptchaRegistrationView, CaptchaPasswordResetView, delete_account_view, \
...
urlpatterns = [
    url(r'^gitrefinery/', include('gitrefinery.urls')),
    ...
    url(r'.*', RedirectView.as_view(url='/gitrefinery/')),
]
